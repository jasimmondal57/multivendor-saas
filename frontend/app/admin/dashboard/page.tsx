            ...
            <tbody>
              {vendors.map((vendor) => (
                <tr key={vendor.id} className="border-b border-gray-100 hover:bg-gray-50">
                  ...
                  <td className="py-3 px-4 text-gray-700">{vendor.user.name}</td>
                  <td className="py-3 px-4 text-gray-700">{vendor.user.email}</td>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  <div>
                    ...
                    <p className="text-gray-900">{viewingVendor.business_type || 'N/A'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Owner Name</label>
                    <p className="text-gray-900">{viewingVendor.user.name}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Email</label>
                    <p className="text-gray-900">{viewingVendor.user.email}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Phone</label>
                    <p className="text-gray-900">{viewingVendor.business_phone || 'N/A'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Website</label>
                    <p className="text-gray-900">{viewingVendor.website || 'N/A'}</p>
                  </div>
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  <div>
                    ...
                    <p className="text-gray-900 font-mono">{viewingVendor.gstin || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">PAN</label>
                    <p className="text-gray-900 font-mono">{viewingVendor.pan || 'Not provided'}</p>
                  </div>
                  <div>
                    <label className="text-sm font-medium text-gray-600">Aadhaar</label>
                    <p className="text-gray-900 font-mono">{viewingVendor.aadhaar || 'Not provided'}</p>
                  </div>
                  <div>
                    ...
                    <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                      ...
                      {viewingVendor.kyc_status ? viewingVendor.kyc_status.charAt(0).toUpperCase() + viewingVendor.kyc_status.slice(1) : 'N/A'}
                    </span>
                  </div>
                </div>
              </div>
                  ...
                  <div>
                    ...
                    <p>
                      <span className={`px-3 py-1 rounded-full text-xs font-semibold ${
                        ...
                        {viewingVendor.verification_status ? viewingVendor.verification_status.charAt(0).toUpperCase() + viewingVendor.verification_status.slice(1) : 'N/A'}
                      </span>
                    </p>
                  </div>
                  {viewingVendor.suspension_reason && (
                    <div className="col-span-2">
                      <label className="text-sm font-medium text-gray-600">Suspension Reason</label>
                      <p className="text-red-700 bg-red-50 p-3 rounded-lg">{viewingVendor.suspension_reason}</p>
                    </div>
                  )}
                </div>
              </div>
              ...
              <div>
                ...
                <div className="grid grid-cols-3 gap-4">
                  <div className="bg-blue-50 p-4 rounded-lg">
                    <label className="text-sm font-medium text-blue-600">Total Sales</label>
                    <p className="text-2xl font-bold text-blue-900">₹{viewingVendor.total_sales || 0}</p>
                  </div>
                  <div className="bg-green-50 p-4 rounded-lg">
                    <label className="text-sm font-medium text-green-600">Total Orders</label>
                    <p className="text-2xl font-bold text-green-900">{viewingVendor.total_orders || 0}</p>
                  </div>
                  <div className="bg-yellow-50 p-4 rounded-lg">
                    <label className="text-sm font-medium text-yellow-600">Average Rating</label>
                    <p className="text-2xl font-bold text-yellow-900">{viewingVendor.average_rating || 0} ⭐</p>
                  </div>
                </div>
              </div>
            </div>
